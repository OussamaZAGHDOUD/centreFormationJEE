...
<div class="container">
<form class="form-inline"  action="etudiant.do">
          <input class="form-control mr-sm-2" type="search" placeholder="Search" aria-label="Search" name="nomEt">
          <button class="btn btn-outline-info my-2 my-sm-0" type="submit">Chercher <i class="fa fa-search" aria-hidden="true"></i></button>
          <a class="btn btn-primary pull-right" style="margin-left: 600px;"  href="ajouter.do"><i class="fa fa-plus-circle" aria-hidden="true"></i>
...
<tr>
<!-- <th>Matricule</th> -->
<th>Nom</th><th>Adresse</th><th>Numéro Tel</th><th>Email</th><th></th><th></th><th>Nombre totale : ${liste.getEtudiants().size()}</th>
</tr>
<c:forEach items="${liste.getEtudiants()}" var="e">
