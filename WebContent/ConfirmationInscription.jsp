			...
			<div class="row align-items-center d-flex">
				...
				<nav id="nav-menu-container" class="ml-auto">
					<ul class="nav-menu white">
						...
						<li><a>Bonjour <%if(session.getAttribute("nom")!=null) %>${nom}</a></li>
		...
		<div class="container">
			<div class="row d-flex align-items-center justify-content-center">
				<div class="about-content col-lg-12">
					<h1 class="text-white">
Merçi pour votre inscription</h1><br>
<h3>Nos sessions pour le mois actuel</h3>
				
				<div>	
					<select class="form-control form-control-lg"
					required="required" form="h" name="choixFormation" 	>			
						<c:forEach items="${liste}" var="s">
							<option value="${s.getIdSession()}">${is.getSessionNom(s.getIdSession())}</option>
						</c:forEach>
				</select>
				</div>	
