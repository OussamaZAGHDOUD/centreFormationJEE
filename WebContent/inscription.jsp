		...
		<div class="container">
			<div class="row d-flex align-items-center justify-content-center">
				<div class="about-content col-lg-12">
					<h1 class="text-white">
S'inscrire pour réserver votre formation					</h1>
					<p class="link-nav">
						<span class="box">
	...
	<!-- Start contact-page Area -->
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-8">
					<form class="submit"  action="Sinscrire.visiteur" method="post">
						<div class="row">
							<div class="col-lg-6 form-group form-group-top">
								<input name="nom"  placeholder="Entrer votre nom" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter your name'"
								...
								<input name="adresse"  placeholder="Entrer votre adresse" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Entrer votre adresse'"
								 class="common-input mb-20 form-control" required="required" type="text">
								 
								 <input name="numTel" placeholder="Entrer votre numéro de téléphone" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Entrer votre numéro de téléphone'"
								 class="common-input mb-20 form-control" required="required" type="text">
							...
							<div class="col-lg-12">
								...
								<button class="primary-btn" style="float: right;" data-text="S'inscrire">
									<span>S</span>
									<span>'</span>
									<span>i</span>
									<span>n</span>
